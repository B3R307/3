...
// ++ YOUR CODE below
 ...
 function hasDoubleLetters(someString){
    // console.log(someString);
    var have = false
    var strInLowerCase = someString.toLowerCase()
    // console.log(strInLowerCase);

    for(var i = 0; i < strInLowerCase.length; i ++){
       var strIteration = strInLowerCase[i]

       if(strIteration === strInLowerCase[i+1]){
         have = true
       }
    }
          // console.log(have);
